...
getCost <- function(sites){
  ...
  pblapply(from_sites, function(x){
    ...
    execGRASS('r.what', map = 'walk_costs', points = "ad1200", separator = ',', intern = T) %>%
      data_frame(x = .) %>% 
...
ad1200_costs <- getCost(ad1200)
ad1250_costs <- getCost(ad1250)
ad1300_costs <- getCost(ad1300)
ad1350_costs <- getCost(ad1350)
ad1400_costs <- getCost(ad1400)
