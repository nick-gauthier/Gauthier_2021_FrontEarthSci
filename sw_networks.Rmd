...
```{r fig.margin = TRUE, network_plot, echo = FALSE, fig.height = 18, fig.width = 6}
...
Next we'll do this transformation. This allows us to factor out the influence of site size and focus on the relative attractivities of each 
