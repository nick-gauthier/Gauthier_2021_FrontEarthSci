...
clim_models <- c(
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr')",
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr') + s(precip_from, bs = 'cr') + s(precip_to, bs = 'cr') ",
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr') + s(temp_from, bs = 'cr') + s(temp_to, bs = 'cr') ",
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr') + s(precip_from, bs = 'cr') + s(precip_to, bs = 'cr') + s(temp_from, bs = 'cr') + s(temp_to, bs = 'cr') ",
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr') + s(temp_from, temp_to) + s(precip_from, precip_to)",
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr') + s(temp_from, bs = 'cr') + s(temp_to, bs = 'cr') + s(precip_from, precip_to)",
      "s(distance, bs = 'cr') + s(centrality_from, bs = 'cr') + s(centrality_to, bs = 'cr') + s(precip_from, bs = 'cr') + s(precip_to, bs = 'cr') + s(temp_from, temp_to)"
      ) %>%
  paste('similarity ~', .) %>%
  tibble(formula_chr = .) %>%
  mutate(formula = purrr::map(formula_chr, as.formula), 
