...
%\end{equation}
%where $c_{ij}$ is  and is symmetric, meaning $c_{ij} = c_{ji}$. Which states that the flow of people, goods, or information from site $i$ to site $j$ is a function of some property $v$ of site $i$, property $w$ of site $j$, and $c_{ij}$ some notion of the generalized cost of moving from $i$ to $j$ with $c_{ij} = c_{ji}$. Gravity models of this form are quasisymmetric, and can be decomposed into symmetric and asymmetric components \parencite{Bavaud2002,Bavaud2008}. 
