...
to go
  ask turtle 0 [ set size size + size * r * (1 - size / k) - size * mean [ size ] of link-neighbors]
  ;make-node find-partner         ;; find partner & use it as attachment
                                 ;; point for new node
  ask turtle 1 [ set size size + size * mean [ size ] of link-neighbors - size * death-rate ]
