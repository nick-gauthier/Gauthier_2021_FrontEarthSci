...
# now binary
E(ad1200)$eof1.b <- factor(sign(V(ad1200)[el[, 1]]$eof1) != sign(V(ad1200)[el[, 2]]$eof1), ordered = F)
E(ad1200)$eof2.b <- factor(sign(V(ad1200)[el[, 1]]$eof2) != sign(V(ad1200)[el[, 2]]$eof2), ordered = F)
E(ad1200)$eof3.b <- factor(sign(V(ad1200)[el[, 1]]$eof3) != sign(V(ad1200)[el[, 2]]$eof3), ordered = F)
E(ad1200)$eof4.b <- factor(sign(V(ad1200)[el[, 1]]$eof4) != sign(V(ad1200)[el[, 2]]$eof4), ordered = F)
E(ad1200)$eof5.b <- factor(sign(V(ad1200)[el[, 1]]$eof5) != sign(V(ad1200)[el[, 2]]$eof5), ordered = F)
E(ad1200)$eof6.b <- factor(sign(V(ad1200)[el[, 1]]$eof6) != sign(V(ad1200)[el[, 2]]$eof6), ordered = F)
